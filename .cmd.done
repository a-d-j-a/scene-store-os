...
rm -f /tmp/serial.log /tmp/scr3.png
...
sleep 120
echo "screendump /tmp/scr3.png" | socat - unix-connect:/tmp/qmon.sock
cp /tmp/serial.log /tmp/scr3.png /workspaces/scene-store-os/
echo CMD_CYCLE_3_DONE
